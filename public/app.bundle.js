...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Task\": () => (/* binding */ Task)\n/* harmony export */ });\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\n/* harmony import */ var react_native_media_query__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-native-media-query */ \"./node_modules/react-native-media-query/index.js\");\n/* harmony import */ var react_native_web_dist_exports_View__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-native-web/dist/exports/View */ \"./node_modules/react-native-web/dist/exports/View/index.js\");\n/* harmony import */ var react_native_web_dist_exports_Text__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-native-web/dist/exports/Text */ \"./node_modules/react-native-web/dist/exports/Text/index.js\");\n/* harmony import */ var react_native_web_dist_exports_CheckBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-native-web/dist/exports/CheckBox */ \"./node_modules/react-native-web/dist/exports/CheckBox/index.js\");\n/* harmony import */ var _styles_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./styles.js */ \"./src/styles.js\");\n\n\n\n\n\n\n\nconst ESCAPE_KEY = 27;\nconst ENTER_KEY = 13;\nconst textStyle = 'red';\nconst Task = ({\n  task,\n  onEditTask,\n  onDeleteTask,\n  showDate,\n  validateTask\n}) => {\n  const [editing, setEditing] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false); //if editing - renders input\n\n  const [editText, setEditText] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(task.title); //Controlled input\n\n  function handleKeyDown(event) {\n    if (event.key === ESCAPE_KEY) {\n      setEditText(task.title);\n      setEditing(false);\n    } else if (event.which === ENTER_KEY) {\n      if (!validateTask(editText, task.id)) {\n        alert(\"Task already exists\");\n        setEditText(task.title);\n        return;\n      }\n\n      onEditTask(task.id, task.status, editText);\n      setEditing(false);\n    }\n  }\n\n  function handleStatusChange() {\n    onEditTask(task.id, task.status === \"active\" ? \"completed\" : \"active\", task.title);\n  }\n\n  function handleDelete() {\n    onDeleteTask(task.id);\n  }\n\n  if (editing) {\n    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_styles_js__WEBPACK_IMPORTED_MODULE_2__.TaskEditInput, {\n      autoFocus: true,\n      name: \"editTask\",\n      value: editText,\n      placeholder: \"Add task\",\n      onChange: e => setEditText(e.target.value),\n      onBlur: () => {\n        if (!validateTask(editText, task.id)) {\n          alert(\"Task alreadyy exists\");\n          setEditText(task.title);\n          setEditing(false);\n          return;\n        }\n\n        setEditing(false);\n        onEditTask(task.id, task.status, editText);\n      },\n      onKeyPress: e => handleKeyDown(e)\n    });\n  }\n\n  const {\n    ids,\n    styles\n  } = react_native_media_query__WEBPACK_IMPORTED_MODULE_1__[\"default\"].create({\n    text: {\n      \"@media (max-width: 1600px) and (min-width: 800px)\": {\n        maxWidth: \"90%\"\n      },\n      \"@media (max-width: 800px) and (min-width: 451px)\": {\n        width: \"90%\",\n        maxWidth: 500\n      },\n      \"@media (max-width: 450px)\": {\n        width: \"90%\",\n        maxWidth: 250\n      }\n    } // container: {\n    // \t\"@media (max-width: 1600px) and (min-width: 800px)\": {\n    //   \tmaxWidth:\"90%\",\n    //     backgroundColor: \"blue\"\n    //   },\n    //   \"@media (max-width: 800px) and (min-width: 451px)\": {\n    //   \twidth: \"60%\",\n    //   \tmaxWidth: \"300%\",\n    //     backgroundColor: \"peru\"\n    //   },\n    //   \"@media (max-width: 450px)\": {\n    //   \twidth: \"50%\",\n    //   \tmaxWidth: 300,\n    //     backgroundColor: \"red\"\n    //   }\n    // }\n\n  });\n  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_styles_js__WEBPACK_IMPORTED_MODULE_2__.TaskContainer, {\n    style: {\n      flexWrap: \"nowrap\",\n      width: \"100%\"\n    }\n  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_styles_js__WEBPACK_IMPORTED_MODULE_2__.InlineContainer, {\n    style: {\n      width: showDate ? \"50%\" : \"80%\"\n    }\n  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_native_web_dist_exports_CheckBox__WEBPACK_IMPORTED_MODULE_3__[\"default\"], {\n    className: \"toggle\",\n    value: task.status === \"completed\",\n    onChange: () => handleStatusChange()\n  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_native_web_dist_exports_View__WEBPACK_IMPORTED_MODULE_4__[\"default\"], {\n    style: {\n      width: showDate ? \"100%\" : \"100%\",\n      textDecoration: task.status === \"completed\" ? 'line-through' : 'none'\n    }\n  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_styles_js__WEBPACK_IMPORTED_MODULE_2__.TaskText, {\n    style: styles.text,\n    dataSet: {\n      media: ids.text\n    },\n    onClick: () => setEditing(true)\n  }, task.title))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_styles_js__WEBPACK_IMPORTED_MODULE_2__.InlineContainer, {\n    style: {\n      width: showDate ? 155 : 65,\n      justifyContent: 'flex-end'\n    }\n  }, showDate ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_styles_js__WEBPACK_IMPORTED_MODULE_2__.TaskDate, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_native_web_dist_exports_Text__WEBPACK_IMPORTED_MODULE_5__[\"default\"], null, new Date(task.created).toLocaleDateString())) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_native_web_dist_exports_Text__WEBPACK_IMPORTED_MODULE_5__[\"default\"], null, \" \"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_styles_js__WEBPACK_IMPORTED_MODULE_2__.DestroyTaskButton, {\n    onPress: () => handleDelete(),\n    title: \"Delete\"\n  })));\n};\n\n//# sourceURL=webpack://todotestapp/./src/Task.jsx?");
